...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  final _formKey = GlobalKey<FormState>();  //모든 TextFiled의 Valiadtion 기능을 작동시키므러 FormState가 되어야 함

  String userName= '';
  String userEmail= '';
  String userPassword= '';

  void _tryValidation(){      //유효성 검사
          ...
          children: [
            ...
            AnimatedPositioned(  //애니메이션 효과 추가
              ...
              child: AnimatedContainer(
                ...
                child: SingleChildScrollView(  //경고문구가 나올때 오버플로우 되는 것을 방지하기 위함
                      ...
                      Container(
                        ...
                        child: Form(
                          ...
                          child: Column(
                            children: [
                              TextFormField(
                                key: const ValueKey(1),   //입력값의 혼동을 막기위해 key값을 부여함
                                validator: (value){
            ...
            AnimatedPositioned(
              duration: const Duration(milliseconds: 500),
                ...
                top: isSignupScreen? MediaQuery.of(context).size.height-125
                    :MediaQuery.of(context).size.height -165,  //삼항조건을 사용하여 로그인과 사인업을 누를때 구글 아이콘의 위치가 바뀌도록 함
                right: 0,
                left: 0,
                child:Column(
                  children: [
